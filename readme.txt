...
4. window.c         include window operations, such as drawing and creating a window, the ability to print in window, closing window.
5. window.h         header file for window.c
6. project.prj      project file
